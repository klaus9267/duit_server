...
import duit.server.domain.user.exception.UnauthorizedException
    ...
    fun getCurrentUserId(): Long {
        ...
        return when (val principal = authentication.principal) {
            ...
            is String -> principal.toLongOrNull()
                ?: throw UnauthorizedException("유효하지 않은 사용자 정보입니다")

            else -> throw UnauthorizedException("인증되지 않은 사용자입니다")
        }
    }
}
